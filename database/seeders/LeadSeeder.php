...
class LeadSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $additionalUsers = User::whereIn('id', [3, 4, 5])->get();

        if ($additionalUsers->count() < 3) {
        ...
        $this->command->info('Creating leads for User ID 3...');
        $user3Leads = [
            [
                'name' => 'Alex Kimathi',
                'position' => 'CEO',
        ...
        $this->command->info('Creating leads for User ID 4...');
        $user4Leads = [
            [
                'name' => 'Kevin Musyoka',
                'position' => 'CEO',
        ...
        $this->command->info('Creating leads for User ID 5...');
        $user5Leads = [
            [
                'name' => 'Victor Kamau',
                'position' => 'CEO',
